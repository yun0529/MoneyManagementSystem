...
2022-03-31(4차시-실습)
  ...
  Money 클래스
   - Money의 데이터를 저장하는 클래스로 생성자를 통해 사용한돈, 받은돈 등을 입력받아 저장합니다.
   - Money 클래스의 메서드는 저장되어있는 데이터들을 출력하는 역할을 합니다.
  MoneyManager 클래스
   ...
   - addMoney() 메서드에서는 입금된 돈의 이름과 금액을 입력하여 money에 저장합니다.
   - spendMoney() 메서드에서는 사용한 돈의 이름과 금액을 입력하여 money에 저장합니다.
   - editMoney() 메서드에서는 money에 입력되어있는 내역을 수정, 삭제하는 역할을 합니다.
